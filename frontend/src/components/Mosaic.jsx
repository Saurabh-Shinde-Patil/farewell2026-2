...
export default function Mosaic() {
  ...
  return (
    <section id="home" className="w-full bg-background pt-24 pb-2 overflow-hidden flex flex-col items-center justify-center">
      <div className="w-full max-w-4xl px-6 flex justify-center items-center">
        <div className="w-full h-[70px] sm:h-[100px] md:h-[140px] overflow-hidden flex items-center justify-center">
          <img
            src={imageSrc}
            alt="Batch Mosaic Logo"
            className="w-full h-full object-cover object-center select-none pointer-events-none filter drop-shadow-[0_0_8px_rgba(0,240,255,0.25)] transition-all duration-300"
            draggable={false}
          />
        </div>
      </div>
